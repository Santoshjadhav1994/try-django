...
class UserTestCase(TestCase):
    def setUp(self):
        self.user_a = User.objects.create_user('dell',password='password@123')
        
    
    def test_user_pw(self):
        checked = self.user_a.check_password('password@123')
...
class RecipeTestCase(TestCase):
    def setUp(self):
        ...
        self.recipe_ingredient_a = RecipeIngredient.objects.create(recipe=self.recipe_a,
                                                                name='Chicken',quantity='1/2',unit='pound')
        self.recipe_ingredient_b = RecipeIngredient.objects.create(recipe=self.recipe_a,
                                                                name='Chicken',quantity='asdfasdf',unit='pound')
    ...
    def test_two_level_relation_via_recipes(self):
        user = self.user_a
